...
public abstract class e-volveWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static e-volveWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(e-volveWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<e-volveDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<e-volveDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<e-volveDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<e-volveDbContext, Task<T>> func)
    {
        T result;
