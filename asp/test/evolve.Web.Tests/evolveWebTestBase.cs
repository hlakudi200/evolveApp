...
public abstract class evolveWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static evolveWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(evolveWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<evolveDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<evolveDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<evolveDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<evolveDbContext, Task<T>> func)
    {
        T result;
