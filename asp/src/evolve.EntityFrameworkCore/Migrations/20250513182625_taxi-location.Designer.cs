...
namespace evolve.Migrations
{
    ...
    [Migration("20250513182625_taxi-location")]
    partial class taxilocation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("evolve.Domain.PaymentMangement.DriverAccountDetails", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("DriverAccountDetails");
                });
            ...
            modelBuilder.Entity("evolve.Authorization.Users.User", b =>
                {
                    ...
                    b.HasOne("evolve.Domain.TaxiManagement.Taxi", null)
                        .WithMany("Passangers")
            ...
            modelBuilder.Entity("evolve.Domain.DriverManagement.Driver", b =>
                {
                    ...
                    b.HasOne("evolve.Authorization.Users.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("evolve.Domain.PassengerManagement.Payment", b =>
                {
                    ...
                    b.HasOne("evolve.Domain.PaymentManagement.Payout", "Payout")
                        .WithMany("Payments")
            ...
            modelBuilder.Entity("evolve.Domain.PaymentMangement.DriverAccountDetails", b =>
                {
                    b.HasOne("evolve.Domain.DriverManagement.Driver", "Driver")
                        ...
                        .HasForeignKey("evolve.Domain.PaymentMangement.DriverAccountDetails", "DriverId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
