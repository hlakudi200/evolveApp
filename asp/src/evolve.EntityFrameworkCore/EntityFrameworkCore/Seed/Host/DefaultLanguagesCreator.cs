...
namespace evolve.EntityFrameworkCore.Seed.Host;

public class DefaultLanguagesCreator
{
    public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

    private readonly evolveDbContext _context;

    private static List<ApplicationLanguage> GetInitialLanguages()
    {
        var tenantId = evolveConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
    ...
    public DefaultLanguagesCreator(evolveDbContext context)
    {
        _context = context;
    }
